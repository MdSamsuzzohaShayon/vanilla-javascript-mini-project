...
function validation(event) {
    ...
    let input_field = document.getElementsByClassName('text_field'); // Fetching all inputs with same class name text_field and an html tag textarea.
    ...
    for (let i = input_field.length; i > count; i--) {
